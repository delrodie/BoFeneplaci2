...
class ObjectifController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_objectif_show', array('slug' => $objectif->getSlug()));
        }
     ...
     *
     * @Route("/{slug}", name="admin_objectif_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{slug}/edit", name="admin_objectif_edit")
     * @Method({"GET", "POST"})
     */
